...
{
    public class AnnonuncementValidator : AbstractValidator<AnnonuncementAddDTO>
    {
        public AnnonuncementValidator()
        {
            ...
            RuleFor(x => x.Content).MaximumLength(50).WithMessage("Başlık en fazla 50 karekter olmalı");
